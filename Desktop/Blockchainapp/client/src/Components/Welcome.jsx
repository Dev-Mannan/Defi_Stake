...
const Welcome = () => {
  ...
  // Example of initializing currentAccount in component state
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            ...
            <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism">
                <div className="flex justify-between flex-col w-full h-full">
                    ...
                    <div>
                        <p className="text-white font-light text-sm">0x0.....Loading</p>
                        <p className="text-white font-semibold text-lg">Ethereum Address</p>
                    </div>
            ...
            <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                ...
                <Input placeholder="Sending Amount" name="amount" type="number" handleChange={handleChange} />
